...
#pragma warning restore 0649
        ...
        {
            var resources = Resources.LoadAll<SteamVrControllerDefinition>("Controllers");
            Array.ForEach(resources, Debug.Log);
            return resources.FirstOrDefault(type => type.controllerId == id);
        }
